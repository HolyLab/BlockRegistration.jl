...
function Base.LinAlg.A_mul_B!(dest::AbstractVector{T},
...
function _A_mul_B!(g, P::AffineQHessian{AffinePenalty{T,N}}, u) where {T,N}
    gridsize = size(P.Qs)
    λ = P.ap.λ
...
function affine_part!(::Void, P::AffineQHessian{AP,M,N,Φ}, u) where {AP,M,N,Φ<:GridDeformation}
...
function Base.LinAlg.A_mul_B!(y::AbstractVector,
                              P::TimeHessian{AQH},
